...
However, double precision could be implement with little effort.
\par
...
If any of bits with position larger or equal than 276 are set, an overflow in fixed-point accumulator occurred.
\par
